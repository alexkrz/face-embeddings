...
def iresnet18(progress=True, **kwargs):
    return _iresnet("iresnet18", IBasicBlock, [2, 2, 2, 2], progress, **kwargs)


def iresnet34(progress=True, **kwargs):
    return _iresnet("iresnet34", IBasicBlock, [3, 4, 6, 3], progress, **kwargs)


def iresnet50(progress=True, **kwargs):
    return _iresnet("iresnet50", IBasicBlock, [3, 4, 14, 3], progress, **kwargs)
